...
export default function HeroBanner(){
    return(
        <section> 
            ...
            <h1 className="px-2 py-2 text-2xl md:text-4xl lg:text-5xl bg-green-700/30 backdrop-invert backdrop-opacity-10 font-bold text-3xlfont-bold text-shadow-lg/30">Seu Guia Atualizado em Finanças, Cripto e Tecnologia</h1>
