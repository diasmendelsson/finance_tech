    ...
    <main className=" flex flex-col items-center px-10 py-10 font-[family-name:var(--font-geist-sans)] gap-4 overflow-hidden">
      ...
      <section  className="mt-8 w-full flex flex-col items-center">
        ...
        <p className="w-xl space-y-4 text-base">
          ...
          provedor de internet, configurando redes e roteadores, mas sempre fui
          curioso pra entender o que acontecia por trás das telas. Foi assim que
          entrei no mundo da programação. Entre um plantão técnico e outro,
          mergulhei em estudos sobre JavaScript, Next.js, APIs, redes, backend,
          e também sobre como a internet, os dados e os dispositivos se conectam
      ...
      <section  className="mt-8 w-full flex flex-col items-center py-4 ">
        ...
        <p className="w-xl space-y-4 text-base">
          ...
          foi um ponto de virada. Acredito que todo mundo merece entender como o
          dinheiro funciona e como a tecnologia pode ser uma aliada na vida —
