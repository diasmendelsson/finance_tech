...
export default async function postAction(prevState, formData) {
  ...
  try {
    await pool.query(
      'INSERT INTO publicacoes (title, description, slug, imagebanner, content, tags) VALUES ($1, $2, $3, $4, $5, $6)',
      [title, description, slug, imageBanner1Path, JSON.stringify(conteudoArray), uniqueTags]
    );
